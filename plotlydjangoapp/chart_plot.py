...
class ChartPlot:
    ...
    def line_full(self):
        ...
        trace1 = go.Scatter(
            ...
            line=go.Line(color='rgb(56,138,255)'),
            showlegend=False,
            name='恒宝股份',
        )
        trace2 = go.Scatter(
            ...
            line=go.Line(color='rgb(235,110,56)'),
            name='湘潭电化',
            showlegend=False,
        )
        trace3 = go.Scatter(
        ...
        trace4 = go.Scatter(
            x=x,
            y=y1,
            line=go.Line(color='rgb(20,60,215)'),
            mode='lines',
            name='恒宝股份',
        )
        trace5 = go.Scatter(
            x=x,
            y=y2,
            line=go.Line(color='rgb(30,144,5)'),
            mode='lines',
            name='湘潭电化',
        )
        trace6 = go.Scatter(
    ...
    def four_char(self):
        ...
        data = pd.read_csv(CURRENT_PATH + r'/cars.csv', index_col=[0])
        ...
        trace1 = go.Scatter3d(x=data['curb-weight'],
                              y=data['horsepower'],
                              z=data['price'],
                              mode='markers',
                              ...
                              line=dict(color='rgba(217, 217, 217, 0.14)', width=0.02)
                              )
